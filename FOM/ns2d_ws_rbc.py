...
tad = '602'
if int(numRun) < 10:
    temp1 = 'solution_'+tad+'_511_255_0.001_'+numRun+'.0e+06/save/'+'000.npz'
elif int(numRun) < 20:
    e7numRun = str(int(numRun)-10)
    temp1 = 'solution_'+tad+'_511_255_0.001_'+e7numRun+'.0e+07/save/'+'000.npz'
else:
    if int(numRun) == 21:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.1e+07/save/'+'000.npz'
    elif int(numRun) == 22:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.2e+07/save/'+'000.npz'
    elif int(numRun) == 23:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.3e+07/save/'+'000.npz'
    elif int(numRun) == 24:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.4e+07/save/'+'000.npz'
    elif int(numRun) == 25:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.5e+07/save/'+'000.npz'
    elif int(numRun) == 26:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.6e+07/save/'+'000.npz'
    elif int(numRun) == 27:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.7e+07/save/'+'000.npz'        
    elif int(numRun) == 28:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.8e+07/save/'+'000.npz'
    elif int(numRun) == 29:
        temp1 = 'solution_'+tad+'_511_255_0.001_1.9e+07/save/'+'000.npz'        

temp = np.load('/scratch/sakbari/FOM/result/'+temp1)
print("temperature shape = ",temp.f.th.shape)
th = temp.f.th
w = temp.f.w
s = temp.f.s
''''''
